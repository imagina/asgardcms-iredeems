...
<div id="body">
  <div id="template-mail">
    ...
    <div id="contend-mail" class="p-3">
      ...
      {{-- ***** Customer  ***** --}}
      <p class="px-3">
        <strong>Has canjeado el siguiente artículo con tus puntos en tubarrioenlinea.com:</strong>
        <br>
      </p>
      ...
      <div style="margin-bottom: 5px">
        ...
        <br>
        <p class="px-3">
          Por favor, comuníquese con anticipación a la administración del sitio
          para mas detalles sobre la entrega del item canjeado
        </p>
        <br>
      </div>
    </div>
